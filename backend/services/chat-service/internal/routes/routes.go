...
func Register(app *fiber.App, cfg *config.Config, repo *repository.MongoRepository, kp *kafka.Producer, redisClient *cache.Client, hub *ws.Hub, kc *kafka.Consumer, jwtMw *middleware.JWTMiddleware) {
